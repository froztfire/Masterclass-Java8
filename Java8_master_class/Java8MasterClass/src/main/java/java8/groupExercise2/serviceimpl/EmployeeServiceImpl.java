package java8.groupExercise2.serviceimpl;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public List<Employee> getEmployeeByName(String name, SortEnum sortEnum) {
        ...
        return getMatchedEmployees(e -> buildEmployeeFullName(e).toLowerCase().contains(lowerCaseName), sortEnum);
    }

    private String buildEmployeeFullName(Employee employee) {
        return String.format("%s %s %s", employee.getFirstName(), employee.getMiddleName(), employee.getLastName());
    }

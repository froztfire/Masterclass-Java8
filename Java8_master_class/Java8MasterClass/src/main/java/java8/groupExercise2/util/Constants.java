...
public class Constants {
    ...
    //-------------------------CONSTANTS FOR DISPLAYING RECORDS----------------------//
    ...
    //-------------------------CONSTANTS FOR MENU INSTRUCTIONS----------------------//
    ...
    public static final String INSTRUCTION_ENTER_FULL_NAME = "Enter Name: ";


    //-------------------------CONSTANTS FOR RETURNING MESSAGE----------------------//
    ...
    public static final String OPTION_SEARCH_BY_FULL_NAME = "Search by Name";
    ...
    public static final String OPTION_SORT_BY_NAME = "Search By Name";
